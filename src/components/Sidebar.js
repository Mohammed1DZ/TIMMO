...
// Ensure dependencies are correctly set
    ...
    return (
        <div
            className={`bg-[#080703] text-white h-screen transition-all duration-300 ${
                isHovered ? 'w-48' : 'w-16'
        ...
        >
            ...
            <ul className="space-y-6 w-full">
                {links.length > 0 ? (
                                ...
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        `flex items-center space-x-4 p-2 rounded-md transition-colors duration-300 ${
                                            isActive ? 'bg-[#080704] text-black' : 'text-white hover:bg-gray-700'
                                        }`
                                    }
                                >
                    ...
                    <li className="text-white">No links available</li>
                )}
            </ul>
            ...
            <button
                ...
                className="mb-6 flex items-center space-x-2 p-2 rounded-md transition-colors duration-300 text-white hover:text-white hover:bg-red-600 w-full"
            >
